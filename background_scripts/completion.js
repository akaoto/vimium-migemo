...
// Furthermore, RegexpCache.get() method is modified to search with Migemo by akaoto at 2017-11-07.
(function() {
  ...
  RegexpCache = {
    ...
    get: function(string, prefix, suffix) {
      ...
      regexpString = prefix + regexpString + suffix;
      return (base = this.cache)[regexpString] || (base[regexpString] = MigemoJS.getRegExp(regexpString));
    }
  };
