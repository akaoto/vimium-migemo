...
(function() {
  ...
  LinkHintsMode = (function() {
    ...
    LinkHintsMode.prototype.onKeyDownInMode = function(event) {
      var handlerId, key, keyChar, previousMode, previousTabCount, ref, ref1;
      if (event.repeat) {
        return;
      }
  ...
  LocalHints = {
    getVisibleClickable: function(element) {
      ...
      if (element.hasAttribute("onclick") || ((ref5 = (ref6 = element.getAttribute("role")) != null ? ref6.toLowerCase() : void 0) === "button" || ref5 === "tab" || ref5 === "link") || ((ref7 = (ref8 = element.getAttribute("contentEditable")) != null ? ref8.toLowerCase() : void 0) === "" || ref7 === "contentEditable" || ref7 === "true")) {
        isClickable = true;
      }
