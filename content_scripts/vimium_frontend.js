...
(function() {
  ...
  extend(root, {
    reload: function(count, options) {
      var hard, ref;
      hard = (ref = options.registryEntry.options.hard) != null ? ref : false;
      return window.location.reload(hard);
    },
  ...
  root.showHelp = function(sourceFrameId) {
